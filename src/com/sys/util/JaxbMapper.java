...
public class JaxbMapper {
	...
	public static String toXmlLine(Object root, String encoding, boolean isFmt) {
		try {
			Class clazz = Reflections.getUserClass(root);
			Marshaller marshaller = JaxbMapper.createMarshaller(clazz, encoding);
			marshaller.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, isFmt);
