...
public class JFinalDb extends Db {
	 ...
	 * @throws Exception
	 */
	public static ScriptPage findPage(int pageNo, int pageSize, String sql, Map<String, Object> mapwhere,
	 ...
	 */
	public static ScriptPage findPage(int pageNo, int pageSize, String sql, Map<String, Object> mapwhere,
			String orderstr, Object... params) throws Exception {
		ScriptPage spage = new ScriptPage();
...
//		StringBuffer sqlExceptSelect = new StringBuffer(sql.substring(x));
		StringBuffer sqlExceptSelect = new StringBuffer(sql);
		...
		for (Entry<String, Object> en : mapwhere.entrySet()) {
			if (en.getValue() == null) {
				...
				if (key.startsWith("LIKE-")) {
					where.append(" and ").append(key.substring(5)).append(" like '%").append(en.getValue())
							.append("%'");
		...
		String sqlExceptSelectstr = " from (" + sqlExceptSelect.toString().replace("${where}", where.toString())+") xxxx ";
		Page<Record> pages = null;
	...
	public static ScriptPage findPageBySqlid(int pageNo, int pageSize, String sqlid, Map<String, Object> mapwhere,
			String orderstr) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static ScriptPage findPageBySqlIdAddedSql(int pageNo, int pageSize,String sqlId, String addsql, Map<String, Object> mapwhere,
			String orderstr, Object... params) throws Exception {
		return findPage(pageNo, pageSize, JdbcSql.getSql(sqlId)+addsql, mapwhere, orderstr, params);
	}
