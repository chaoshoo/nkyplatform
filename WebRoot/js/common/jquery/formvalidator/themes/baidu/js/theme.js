...
var passwordStrengthRule = [
	...
	{level:2,rule:[
				   {flag:8,value:[0]},				//特符
				   {flag:9,value:[1,1]},		//number(>=1)+特符>=1)
				   {flag:10,value:[1,1]},		//小写(>=1)+特符>=1)
				   {flag:12,value:[1,1]},		//大写(>=1)+特符>=1)
				   {flag:3,value:[1,1]},	//number(>=1)+小写(>=1)
				   {flag:5,value:[1,1]},	//number(>=1)+大写(>=1)
				   {flag:6,value:[1,1]}			//小写(>=1)+大写(>=1)
				  ]
	},
	{level:3,rule:[
				   {flag:11,value:[1,1,1]},	//number(>=1)+小写(>=1)+特符(>=1)
				   {flag:13,value:[1,1,1]},	//number(>=1)+大写(>=1)+特符(>=1)
				   {flag:14,value:[1,1,1]},	//小写(>=1)+大写(>=1)+特符(>=1)
				   {flag:7,value:[1,1,1]}	//number(>=1)+小写(>=1)+大写(>=1)
				  ]
	}
];