...
},beforePageText:"No.",afterPageText:"page common{pages}page",displayMsg:"display{from}reach{to} common{total}Record",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.messager.defaults={ok:"Confirmed",cancel:"cancel"};
})(jQuery);
(function($){
function _277(_278){
...
$("<div class=\"tabs-header\">"+"<div class=\"tabs-scroller-left icon-chevron-left\"></div>"+"<div class=\"tabs-scroller-right   icon-chevron-right\"></div>"+"<div class=\"tabs-wrap\">"+"<ul class=\"tabs\"></ul>"+"</div>"+"</div>").prependTo(_2de);
...
var a=$(e.target).closest("a.icon-remove");
if(a.length){
_2f9(_2e1,_2e2(li));
}else{
if(li.length){
...
tab.find("a.icon-remove").remove();
if(opts.closable){
_2f5.addClass("tabs-closable");
$("<a href=\"javascript:void(0)\" class=\"icon-remove\"></a>").appendTo(tab);
}else{
...
if(opts.tools){
var _2f7=$("").insertAfter(tab.find("a.tabs-inner"));
...
$.fn.calendar.defaults={width:180,height:180,fit:false,border:true,firstDay:0,weeks:["Seven","One","Two","Three","Four","Five","Six"],months:["January","February","March","April","May","June","July","August","September","October","November","December"],year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date(),onSelect:function(date){
}};
})(jQuery);
(function($){
function init(_46f){
...
_89d(this,q);
}},currentText:"Today",closeText:"Close",okText:"Confirmed",formatter:function(date){
