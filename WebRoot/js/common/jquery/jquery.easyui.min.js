...
$.fn.calendar.defaults={width:180,height:180,fit:false,border:true,firstDay:0,weeks:["Seven","One","Two","Three","Four","Five","Six"],months:["Onemonth","Twomonth","Threemonth","Fourmonth","Fivemonth","Sixmonth","Sevenmonth","August","September","October","十Onemonth","十Twomonth"],year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date(),onSelect:function(date){
}};
})(jQuery);
(function($){
function init(_46f){
