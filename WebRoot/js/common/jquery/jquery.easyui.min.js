...
$.fn.calendar.defaults={width:180,height:180,fit:false,border:true,firstDay:0,weeks:["Seven","One","Two","Three","Four","Five","Six"],months:["One月","Two月","Three月","Four月","Five月","Six月","Seven月","August","September","October","十One月","十Two月"],year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date(),onSelect:function(date){
}};
})(jQuery);
(function($){
function init(_46f){
