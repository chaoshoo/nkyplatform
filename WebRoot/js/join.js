...
//	
	...
	/**地图API中提供的控件有：
	Control：控件的抽象基类，所有控件均继承此类的方法、attribute。通过此类您可实现自定义控件。
	...
	**/
	...
	Circle: 表示地图上的圆。
	InfoWindow：信息窗口也是一种特殊的覆盖物，它可以展示更为丰富的文字和多媒体信息。Be careful：同一时刻只能有一个信息窗口在地图上打开。
...
function save() {
	//新增合作商校验
	    ...
	    $('.weui_btn weui_btn_primary').removeAttr('onclick');//去掉a标签中的onclickEvent
//		var is_qc_flag = "N";
...
//			is_qc_flag = "Y";
//		}
	    $.messager.progress({title : "Data submission", msg : "Data submissionin，One moment please……"});
