...
<body class="easyui-layout">
  <div data-options="region:'center',title:'远程任务管理'" class="regionCenter">
    ...
    <div id="question_detail_dialog" data-options="closed:true,modal:true,title:'咨询信息',iconCls:'icon-save'" style="padding: 5px; width: 750px; height: 550px;">
     	<input type="hidden" id="questionId">
     	咨询内容：     <span id='quest_content'></span> 
     	<br>
     	<br>
     	<br>
     	...
     	<table id="question_detail_table" class="easyui-datagrid" style="height:280px;width:700px;"
			...
			<thead>
				<tr>
					...
					<th data-options="field:'answer_name',width:50">会员名称</th>
