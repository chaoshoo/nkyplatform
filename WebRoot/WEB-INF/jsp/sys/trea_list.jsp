...
<body class="easyui-layout">
  <div data-options="region:'center',title:'accounting management'" class="regionCenter">
    <div id="common_search" class="common_search">
      <input type="button" id="trea_add" class="btn btn-success" value="Add to">
      &nbsp;&nbsp;&nbsp;&nbsp; Accounting name：
  ...
  <div id="trea_detail_dialog" data-options="closed:true,modal:true,title:'Add to',iconCls:'icon-save'" style="padding: 5px; width: 500px; height: 400px;">
